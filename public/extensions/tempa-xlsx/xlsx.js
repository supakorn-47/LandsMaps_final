...
function write_sty_xml(wb, opts) {
  ...
  o[o.length] = ('<fonts count="1"><font><sz val="16"/><color theme="1"/><name val="TH Sarabun PSK"/><family val="2"/><scheme val="minor"/></font></fonts>');
  ...
  var StyleBuilder = function (options) {
    ...
    return {
      ...
      initialize: function (options) {
        ...
        if (!defaultStyle.font) defaultStyle.font = {name: 'TH Sarabun PSK', sz: '16'};
        if (!defaultStyle.font.name) defaultStyle.font.name = 'TH Sarabun PSK';
