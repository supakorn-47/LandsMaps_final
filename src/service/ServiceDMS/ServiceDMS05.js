...
export const DMS05GetDataList = async (body) => {
    return new Promise(async (resolve, reject) => {
        try {
            let authorization = await config_headers();
            await axios.post(URL_API('backOfficeApi/DMS05/Get'), {
...
export const DMS05CreateData = async (body) => {

    return new Promise(async (resolve, reject) => {
        try {
            let authorization = await config_headers();
            await axios.post(URL_API('backOfficeApi/DMS05/Add'), {
...
export const DMS05UpdateData = async (body) => {

    return new Promise(async (resolve, reject) => {
        try {
            let authorization = await config_headers();
            await axios.put(URL_API('backOfficeApi/DMS05/Update'), {
...
export const DMS05RunProcess = async (body) => {
    return new Promise(async (resolve, reject) => {
        try {
            let authorization = await config_headers();
            await axios.post(URL_API('backOfficeApi/DMS05/RunProcess'), {
                "transfer_condition_seq": body.transfer_condition_seq,
