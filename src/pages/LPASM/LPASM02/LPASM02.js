...
import LPASM02List from "./LPASM02List";
import LPASM02Dialog from "./LPASM02Dialog";
import CustomCard from "../../../components/CustomCard/CustomCard";
import PageHeader from "../../../components/PageHeader/PageHeader";
import LPASM02RegisterLinkDialog from "./LPASM02RegisterLinkDialog";
...
export default function LPASM02() {
  ...
  const [openRegisterLinkDialog, setOpenRegisterLinkDialog] = useState(false);
  const [registerLinkData, setRegisterLinkData] = useState(null);
  ...
  const handleSetRegisterLink = async (department_seq) => {
    try {
      const data = await ADM02Services.GetRegisterLink(department_seq);
      setRegisterLinkData({ ...data, departmentSeq: department_seq });
      setOpenRegisterLinkDialog(true);
    } catch (error) {
  ...
  return (
    <div className="page-wrapper">
      ...
      <CustomCard
        ...
        body={
          <LPASM02List
            ...
            onSetRegisterLink={handleSetRegisterLink}
          />
        }
      />
      ...
      <LPASM02RegisterLinkDialog
        data={registerLinkData}
        openDialog={openRegisterLinkDialog}
        setOpenDialog={setOpenRegisterLinkDialog}
        showMessages={showMessages}
      />
    </div>
  );
