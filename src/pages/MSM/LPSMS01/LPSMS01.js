...
//PAGE
import LPSMS01Search from "./LPSMS01Search";
import LPSMS01List from "./LPSMS01List";
import LPSMS01Dialog from "./LPSMS01Dialog";
...
export default function LPSMS01() {
    ...
    <div className="page-wrapper">
      ...
      <CustomCard
        title={
          <PageHeader
            config={{
              title: "ข้อมูล Log ถ่ายโอนข้อมูล",
              actionButton: (
                <div>
                  <Button
      ...
      <CustomCard>
        <LPSMS01List dataTable={dataTable} setDialog={setDialog} />
      </CustomCard>

      {dialog.dialog && <LPSMS01Dialog dialog={dialog} setDialog={setDialog} />}
