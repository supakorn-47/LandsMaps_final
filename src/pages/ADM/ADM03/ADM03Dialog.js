...
export default function ADM03Dialog({
  setDialogPDF,
    ...
    return (
      ...
      >
        <div className="p-grid" style={{ marginBottom: 20 }}>
          ...
          <div
            className={
              formObject.service_file_name !== null ||
              formObject.service_file_name !== undefined
                ? "p-col-6"
                : "p-col-12"
            }
          >
          ...
          {formObject.service_file_name !== null ||
          formObject.service_file_name !== undefined ? (
            // <div style={{ marginTop: '12px' }}><br />{formObject.service_file_name}</div>
            <div className="p-col-6">
              <Button
                label={formObject.service_file_name}
    ...
    const headerReq = () => {
      return (
        <div className="table-header">
          ...
          >
            {/* <label>รายการ พจนานุกรมข้อมูลคำขอ (Request)</label> */}
          </span>
          <span
            className="p-input-icon-right"
            style={{ display: "flex", justifyContent: "right" }}
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              ...
              <Button
                ...
                style={{ width: "94px", marginLeft: "5px" }}
              />
            </div>
          </Panel>
        </div>
